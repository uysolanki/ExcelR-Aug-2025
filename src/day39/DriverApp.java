...
//	System.out.println(cricket.getOwnerName());
//	Turf.greet();
...
//	Demo demo4=  name->System.out.println("Welcome "+name+ " to Delhi you will get Cloud certificate");	
//	demo1.greet();
//	demo2.greet();
//	demo4.greet("Chris");
//	demo4.greet("David");
...
//	Demo demo5=  (name,city)->System.out.println("Welcome "+name+ " to " + city + " you will get Cloud certificate");	
//	demo5.greet("Elcid","Jaipur");
		
//		Demo demo6=(name,city)->"Cloud Architech";
//		
